...
if (isset($tplData['userRole'])) {
    ...
    if ($tplData['userRole'] != 3) {
        ...
        //část pro admina
        $res = "<div class='table-responsive center'><table class='table'><tr><th>ID</th><th>Jméno</th><th>Příjmení</th><th>role</th><th>login</th><th>Akce</th></tr>";
        foreach ($tplData['users'] as $u) {
            ...
            $res .= "<tr><td>$u[id_uzivatel]</td><td>$u[jmeno]</td><td>$u[prijmeni]</td><td>$role</td><td>$u[login]</td>
                        <td><form method='post'>
